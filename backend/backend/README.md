...
1. Create **multiple simulated accounts** (Savings / Current / Wallet), choose a primary source, pause/resume accounts, edit limits/nicknames, and add simulated funds through ledgered credit entries.
...
These are transparent, deterministic portfolio rules — **not a claimed fraud-detection ML model**. The demo transfer limit is ₹1,00,000. Amounts above ₹50,000 enter the HIGH-risk band and are blocked by the deterministic high-risk policy before execution.
