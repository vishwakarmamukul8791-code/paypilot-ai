...
The demo maximum payment is ₹1,00,000. Requests above ₹50,000 enter the HIGH band. When the request remains within the ₹1,00,000 platform cap, available balance, and account daily limit, it is escalated to explicit human approval rather than automatically rejected. The fixed HIGH score is 90/100 and the default hard risk-block threshold is 95.
