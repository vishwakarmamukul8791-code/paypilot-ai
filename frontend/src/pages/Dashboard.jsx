...
export default function Dashboard({ data, selectedAccount, onTryPrompt, onManage }) {
  ...
  if (!data.configured) return (
    <section className="welcome-card">
      <div className="welcome-copy">
        <span className="section-kicker">PAYPILOT AI SANDBOX</span>
  ...
  const lastPayment = data.recent_transactions.find((txn) => txn.direction === 'DEBIT' && txn.category !== 'internal_transfer')
      ...
      <section className="dashboard-hero">
        ...
        <div className="quick-panel">
          ...
          <div className="quick-grid">
            ...
            <button onClick={onManage}><span>⇄</span><b>Transfer money</b><small>Between your accounts</small></button>
